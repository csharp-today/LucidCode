...
namespace LucidCode
{
    public static partial class LucidTestExtensions
    {
        ...
        public static async Task<LightAssertManager> ActAsync(this Task<LightActManager> manager, Action actAction) =>
        ...
        /// <returns>Manager for Assert step</returns>
        public static async Task<AssertManager<TResult>> ActAsync<TResult>(this Task<LightActManager> manager, Func<TResult> actFunc) =>
